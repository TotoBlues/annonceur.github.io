...
<html>
        <head>
            <META HTTP-EQUIV="Refresh" CONTENT="30; URL=https://clemenj.github.io/annonceur.github.io/">
            <title></title>
            <meta charset="utf-8" />
            <link rel="stylesheet" href="css/background.css" media="all" />
            <link rel =stylesheet" href="js/muteVideo.js" media="all" />
        ...
        <body>
                <div class="container">
                    ...
                    <div class="video-foreground">
                        <iframe id="playlist" width="100%" height="100%" src="https://www.youtube.com/embed/wOjbo_ejS08?controls=0&showinfo=0&rel=0&autoplay=1&loop=1&mute=1&playlist=wOjbo_ejS08" frameborder="0" allowfullscreen>
                        </iframe>
                    </div>
                  </div>
                </div>
...
<?php
 ...
 $fichier="http://www.sudouest.fr/gironde/bordeaux/rss.xml"; 
